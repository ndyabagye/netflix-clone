...
function Banner({ netflixOriginals }: Props) {
    ...
    return (
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] md:h-[80vh] lg:justify-end lg:pb-12">
            ...
            <h1 className="text-2xl md:text-4xl lg:text-7xl font-bold">{movie?.title || movie?.name}</h1>
